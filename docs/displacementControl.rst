...
.. class:: displacementControl(nd,dof,incr,numIter=1,dUmin=incr,dUmax=incr)
   ...
   Create a DisplacementControl integrator.  In an analysis step with Displacement Control we seek to determine the time step that will result in a displacement increment for a particular degree-of-freedom at a node to be a prescribed value. A subclass of :class:`integrator`.
