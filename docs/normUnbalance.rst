...
.. class:: normUnbalance(tol,iter,pFlag=0,nType=2,maxincr=-1)
   ...
   Create a NormUnbalance test, which uses the norm of the right hand side of the matrix equation to determine if convergence has been reached. A subclass of :class:`test`.
