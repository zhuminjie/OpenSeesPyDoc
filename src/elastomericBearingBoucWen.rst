...
.. function:: element('elastomericBearingBoucWen', eleTag,*eleNodes,kInit, qd, alpha1, alpha2, mu, eta, beta, gamma '-P', matTag '-Mz', matTag, ['-orient', x1, x2, x3, y1, y2, y3], ['-shearDist', sDratio], ['-doRayleigh'], ['-mass', m])
   :noindex:

   For a two-dimensional problem

.. function:: element('elastomericBearingBoucWen', eleTag,*eleNodes,kInit, qd, alpha1, alpha2, mu, eta, beat, gamma ,'-P', matTag ,'-T', matTag ,'-My', matTag ,'-Mz', matTag ,['-orient' ,[x1, x2, x3], y1, y2, y3] ,['-shearDist', sDratio] ,['-doRayleigh'] ,['-mass, m])
   :noindex:
