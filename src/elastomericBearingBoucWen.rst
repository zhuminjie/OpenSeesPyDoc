...
.. function:: element('elastomericBearingBoucWen', eleTag,*eleNodes,kInit, qd, alpha1, alpha2, mu, eta, beta, gamma '-P', PMatTag '-Mz', TMatTag, ['-orient', x1, x2, x3, y1, y2, y3], ['-shearDist', sDratio], ['-doRayleigh'], ['-mass', m])
   :noindex:

   For a two-dimensional problem

.. function:: element('elastomericBearingBoucWen', eleTag,*eleNodes,kInit, qd, alpha1, alpha2, mu, eta, beta, gamma ,'-P', PMatTag ,'-T', TMatTag ,'-My', MyMatTag ,'-Mz', MzMatTag ,['-orient' ,[x1, x2, x3], y1, y2, y3] ,['-shearDist', sDratio] ,['-doRayleigh'] ,['-mass, m])
   :noindex:
