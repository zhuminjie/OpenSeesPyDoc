...
.. function:: element('elasticBeamColumn', eleTag, *eleNodes, secTag, transfTag, <'-mass', mass>,<'-cMass'>, <'-release', releaseCode>)
   :noindex:
...
.. function:: element('elasticBeamColumn', eleTag, *eleNodes, secTag, transfTag, <'-mass', mass>, <'-cMass'> <'-releasez', releaseCode>, <'-releasey', releaseCode>)
   :noindex:   
   ...
   ``'releaseCode'`` |int|               moment release (optional, 0=no release (default), 1=release at I, 2=release at J, 3=release at I and J)
   ===================================   ===========================================================================
