...
.. function:: uniaxialMaterial('TDConcreteEXP', matTag, fc, fct, Ec, beta, tD, epsshu, psish, Tcr, epscru, sigCr, psicr1, psicr2, tcast)
   ...
   ``psish`` |float|                     fitting parameter of shrinkage time evolution function as per ACI 209R-92
   ``Tcr`` |float|                       creep model age (in days)
   ``epscru`` |float|                    ultimate creep strain (taken from creep tests)
   ``sigCr`` |float|                     concrete compressive stress applied in experimental creep tests (associated with $epscru)
   ``psicr1`` |float|                    fitting parameter of creep time evolution function as per ACI 209R-92
   ``psicr2`` |float|                    fitting parameter of creep time evolution function as per ACI 209R-92
