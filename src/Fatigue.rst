...
.. function:: uniaxialMaterial('Fatigue', matTag, tag, '-E0', E0=0.191, '-m', m=-0.458, '-min', min=-1e16, '-max', max=1e16)
   :noindex:
   ...
   ``tag`` |float|                       Unique material object integer tag for the material that is being wrapped
