...
** For Developers** : If you are interested in developing visualization functions and contributing to ``Get_Rendering`` library, please go through :doc:`src/Plotting_Development_Guide` to understand the existing code. This will be helpful in reducing changes while merging the new codes.
